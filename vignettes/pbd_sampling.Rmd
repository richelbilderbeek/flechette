...
To deal with this problem of inconsistent sampling, two new sample methods have
been added: `shortest` and `longest`. These sample methods always give the shortest
